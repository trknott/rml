...
use file_mari_00
save file_marijuana_0019, replace
...
* all fatalities *
reghdfe fatal_hunthou rml_treat##rml_prepost mml_treat decrim, absorb(fips year) noconstant cluster(fips)
reghdfe fatal_hunthou rml_treat##rml_prepost mml_treat decrim vehmiles_hunthou med_age urate rpc_income, absorb(fips year) noconstant cluster(fips)
reghdfe fatal_noalc_hunthou rml_treat##rml_prepost mml_treat decrim, absorb(fips year) noconstant cluster(fips)
reghdfe fatal_noalc_hunthou rml_treat##rml_prepost mml_treat decrim vehmiles_hunthou med_age urate rpc_income, absorb(fips year) noconstant cluster(fips)

* alcohol fatalities by BAC result*
reghdfe fbac01_hunthou rml_treat##rml_prepost mml_treat decrim, absorb(fips year) noconstant cluster(fips)
reghdfe fbac01_hunthou rml_treat##rml_prepost mml_treat decrim vehmiles_hunthou med_age urate rpc_income, absorb(fips year) noconstant cluster(fips)
reghdfe fbac08_hunthou rml_treat##rml_prepost mml_treat decrim, absorb(fips year) noconstant cluster(fips)
reghdfe fbac08_hunthou rml_treat##rml_prepost mml_treat decrim vehmiles_hunthou med_age urate rpc_income, absorb(fips year) noconstant cluster(fips)
reghdfe fbac10_hunthou rml_treat##rml_prepost mml_treat decrim, absorb(fips year) noconstant cluster(fips)
reghdfe fbac10_hunthou rml_treat##rml_prepost mml_treat decrim vehmiles_hunthou med_age urate rpc_income, absorb(fips year) noconstant cluster(fips)

* alcohol fatalities by age group *
reghdfe fatalalc_age1519_hunthou rml_treat##rml_prepost mml_treat decrim, absorb(fips year) noconstant cluster(fips)
reghdfe fatalalc_age1519_hunthou rml_treat##rml_prepost mml_treat decrim vehmiles_hunthou med_age urate rpc_income, absorb(fips year) noconstant cluster(fips)
reghdfe fatalalc_age2039_hunthou rml_treat##rml_prepost mml_treat decrim, absorb(fips year) noconstant cluster(fips)
reghdfe fatalalc_age2039_hunthou rml_treat##rml_prepost mml_treat decrim vehmiles_hunthou med_age urate rpc_income, absorb(fips year) noconstant cluster(fips)
reghdfe fatalalc_age40up_hunthou rml_treat##rml_prepost mml_treat decrim, absorb(fips year) noconstant cluster(fips)
reghdfe fatalalc_age40up_hunthou rml_treat##rml_prepost mml_treat decrim vehmiles_hunthou med_age urate rpc_income, absorb(fips year) noconstant cluster(fips)

* single-vehicle accidents *
reghdfe fsva_hunthou rml_treat##rml_prepost mml_treat decrim, absorb(fips year) noconstant cluster(fips)
reghdfe fsva_hunthou rml_treat##rml_prepost mml_treat decrim vehmiles_hunthou med_age urate rpc_income, absorb(fips year) noconstant cluster(fips)
reghdfe fsvaalc_hunthou rml_treat##rml_prepost mml_treat decrim, absorb(fips year) noconstant cluster(fips)
reghdfe fsvaalc_hunthou rml_treat##rml_prepost mml_treat decrim vehmiles_hunthou med_age urate rpc_income, absorb(fips year) noconstant cluster(fips)

* descriptive stats *
summarize fatal_hunthou fatal_noalc_hunthou fbac01_hunthou fbac08_hunthou fbac10_hunthou fatalalc_age1519_hunthou fatalalc_age2039_hunthou fatalalc_age40up_hunthou fsva_hunthou fsvaalc_hunthou
summarize mml_treat decrim vehmiles_hunthou med_age urate rpc_income